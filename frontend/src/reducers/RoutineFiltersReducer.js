...
import {RECEIVE_SELECTED_MUSCLE_GROUP, RECEIVE_SIDE, RECEIVE_SELECTED_ROUTINE, RECEIVE_SELECTED_MUSCLE_GROUPS} from "../actions/RoutineFilterActions";
...
export default function (state = _nullState, action) {
    ...
    switch (action.type) {
        ...
        case RECEIVE_SELECTED_MUSCLE_GROUPS:
            nextState = Object.assign({}, state);
            action.muscleGroups.forEach((muscleGroup) => {
                nextState[muscleGroup.name] = true;
            });
            return nextState;
