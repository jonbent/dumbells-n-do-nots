...
export default class OptionCarouselHolder extends Component {
    ...
    render(){
        const { header, items, onClick, selectedItems } = this.props;
        ...
        return (
            <div className="carousel-container">
                ...
                <OptionCarousel items={items} currentIndex={currentIndex} numDivs={numDivs} onClick={onClick} selectedItems={selectedItems}/>
            </div>
        )
