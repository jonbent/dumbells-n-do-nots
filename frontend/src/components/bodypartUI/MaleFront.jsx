    ...
    render(){
        return(
            ...
            <div className="male-front-selector">
                ...
                <img id="front-male-abs" src="/images/maleUI/front/front-abs.png" onClick={this.handleAbsClick} onMouseLeave={()=>this.handleMouseLeave('hoverAbs')} onMouseEnter={()=>this.handleMouseEnter('hoverAbs')} style= {this.state.Abs || this.state.hoverAbs ? {opacity:1} : {opacity:0}}></img>

                <div className="front-male-arms" onClick={this.handleArmsClick} onClick={this.handleArmsClick} onMouseLeave={()=>this.handleMouseLeave('hoverArms')} onMouseEnter={()=>this.handleMouseEnter('hoverArms')} style= {this.state.Arms || this.state.hoverArms ? {opacity:1} : {opacity:0}}>
                ...
                <div className="front-male-chest" onClick={this.handleChestClick} onClick={this.handleChestClick} onMouseLeave={()=>this.handleMouseLeave('hoverChest')} onMouseEnter={()=>this.handleMouseEnter('hoverChest')} style= {this.state.Chest || this.state.hoverChest ? {opacity:1} : {opacity:0}}>
                ...
                <div className="front-male-shoulder" onClick={this.handleShouldersClick} onClick={this.handleShouldersClick} onMouseLeave={()=>this.handleMouseLeave('hoverShoulders')} onMouseEnter={()=>this.handleMouseEnter('hoverShoulders')} style= {this.state.Shoulders || this.state.hoverShoulders ? {opacity:1} : {opacity:0}}>
                ...
                <div className="front-male-legs" onClick={this.handleLegsClick} onClick={this.handleLegsClick} onMouseLeave={()=>this.handleMouseLeave('hoverLegs')} onMouseEnter={()=>this.handleMouseEnter('hoverLegs')} style= {this.state.Legs || this.state.hoverLegs ? {opacity:1} : {opacity:0}}>
