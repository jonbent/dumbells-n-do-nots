    ...
    render(){
        return(
            ...
            <div className="male-front-selector">
                ...
                <img onContextMenu={(e)=> false} id="front-male-abs" src="/images/maleUI/front/front-abs.png" alt="front-abs" onMouseDownCapture={() => this.props.handleClick("Abs")} onMouseLeave={()=>this.props.handleMouseLeave('hoverAbs')} onMouseEnter={()=>this.props.handleMouseEnter('hoverAbs')} style= {this.props.Abs || this.props.hoverAbs ? {opacity:1} : {opacity:0}}></img>

                <div className="front-male-arms" onMouseDownCapture={() => this.props.handleClick("Arms")} onMouseLeave={()=>this.props.handleMouseLeave('hoverArms')} onMouseEnter={()=>this.props.handleMouseEnter('hoverArms')} style= {this.props.Arms || this.props.hoverArms ? {opacity:1} : {opacity:0}}>
                ...
                <div className="front-male-chest" onMouseDownCapture={() => this.props.handleClick("Chest")} onMouseLeave={()=>this.props.handleMouseLeave('hoverChest')} onMouseEnter={()=>this.props.handleMouseEnter('hoverChest')} style= {this.props.Chest || this.props.hoverChest ? {opacity:1} : {opacity:0}}>
                ...
                <div className="front-male-shoulder" onMouseDownCapture={() => this.props.handleClick("Shoulders")} onMouseLeave={()=>this.props.handleMouseLeave('hoverShoulders')} onMouseEnter={()=>this.props.handleMouseEnter('hoverShoulders')} style= {this.props.Shoulders || this.props.hoverShoulders ? {opacity:1} : {opacity:0}}>
                ...
                <div className="front-male-legs"  onMouseDownCapture={() => this.props.handleClick("Legs")} onMouseLeave={()=>this.props.handleMouseLeave('hoverLegs')} onMouseEnter={()=>this.props.handleMouseEnter('hoverLegs')} style= {this.props.Legs || this.props.hoverLegs ? {opacity:1} : {opacity:0}}>
