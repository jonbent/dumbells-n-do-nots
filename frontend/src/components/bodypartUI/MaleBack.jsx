        ...
        return (
            <div className="male-back-container">
                <div className="male-back-selector">
                    ...
                    <img onContextMenu={(e)=>  false} id="back-male-back" src="/images/maleUI/back/back-back.png" alt="back-back" onClick={() => this.props.handleClick("Back")} onMouseLeave={()=>this.props.handleMouseLeave('hoverBack')} onMouseEnter={()=>this.props.handleMouseEnter('hoverBack')} style= {this.props.Back || this.props.hoverBack ? {opacity:1} : {opacity:0}}></img>

                    <img onContextMenu={(e)=>  false} id="back-male-calves" src="/images/maleUI/back/back-calves.png" alt="back-calves" onClick={() => this.props.handleClick("Calves")} onMouseLeave={()=>this.props.handleMouseLeave('hoverCalves')} onMouseEnter={()=>this.props.handleMouseEnter('hoverCalves')} style= {this.props.Calves || this.props.hoverCalves ? {opacity:1} : {opacity:0}}></img>
                    ...
                    <img onContextMenu={(e)=>  false} id="back-male-legs" src="/images/maleUI/back/back-legs.png" alt="back-legs" onClick={() => this.props.handleClick("Legs")} onMouseLeave={()=>this.props.handleMouseLeave('hoverLegs')} onMouseEnter={()=>this.props.handleMouseEnter('hoverLegs')} style= {this.props.Legs || this.props.hoverLegs ? {opacity:1} : {opacity:0}}></img>
                </div>
            </div>
        )
    }
