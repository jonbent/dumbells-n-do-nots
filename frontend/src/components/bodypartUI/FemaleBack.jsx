    ...
    render() {
        return (
            <div className="female-front-container">
                ...
                <img id="back-female-back" alt="back-female-back" src="/images/femaleUI/back/back-female-back.png" onClick={() => this.props.handleClick("Back")} onMouseLeave={()=>this.props.handleMouseLeave('hoverBack')} onMouseEnter={()=>this.props.handleMouseEnter('hoverBack')} style= {this.props.selectableMuscleGroups.Back || this.props.hoverBack ? {opacity:1} : {opacity:0}}></img>

                <img id="back-female-calves" alt="back-female-calves" src="/images/femaleUI/back/back-female-calves.png" onClick={() => this.props.handleClick("Calves")} onMouseLeave={()=>this.props.handleMouseLeave('hoverCalves')} onMouseEnter={()=>this.props.handleMouseEnter('hoverCalves')} style= {this.props.selectableMuscleGroups.Calves || this.props.hoverCalves ? {opacity:1} : {opacity:0}}></img>

                <div className="back-female-legs" onClick={() => this.props.handleClick("Legs")} onMouseLeave={()=>this.props.handleMouseLeave('hoverLegs')} onMouseEnter={()=>this.props.handleMouseEnter('hoverLegs')} style= {this.props.selectableMuscleGroups.Legs || this.props.hoverLegs ? {opacity:1} : {opacity:0}}>
                ...
                <div className="back-female-shoulder" onClick={() => this.props.handleClick("Shoulders")} onMouseLeave={()=>this.props.handleMouseLeave('hoverShoulders')} onMouseEnter={()=>this.props.handleMouseEnter('hoverShoulders')} style= {this.props.selectableMuscleGroups.Shoulders || this.props.hoverShoulders ? {opacity:1} : {opacity:0}}>
                ...
                <div className="back-female-arms" onClick={() => this.props.handleClick("Arms")} onMouseLeave={()=>this.props.handleMouseLeave('hoverArms')} onMouseEnter={()=>this.props.handleMouseEnter('hoverArms')} style= {this.props.selectableMuscleGroups.Arms || this.props.hoverArms ? {opacity:1} : {opacity:0}}>
