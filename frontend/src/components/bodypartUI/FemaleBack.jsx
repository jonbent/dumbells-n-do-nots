...
class FemaleBack extends Component {
    constructor(props){
        super(props);
        this.state = {
            Arms: false,
    ...
    render() {
        return (
            <div className="female-front-container">
                ...
                <img id="back-female-back" alt="back-female-back" src="/images/femaleUI/back/back-female-back.png" onClick={this.handleBackClick} onMouseLeave={()=>this.handleMouseLeave('hoverBack')} onMouseEnter={()=>this.handleMouseEnter('hoverBack')} style= {this.state.Back || this.state.hoverBack ? {opacity:1} : {opacity:0}}></img>

                <img id="back-female-calves" alt="back-female-calves" src="/images/femaleUI/back/back-female-calves.png" onClick={this.handleCalvesClick} onMouseLeave={()=>this.handleMouseLeave('hoverCalves')} onMouseEnter={()=>this.handleMouseEnter('hoverCalves')} style= {this.state.Calves || this.state.hoverCalves ? {opacity:1} : {opacity:0}}></img>

                <div className="back-female-legs" onClick={this.handleLegsClick} onMouseLeave={()=>this.handleMouseLeave('hoverLegs')} onMouseEnter={()=>this.handleMouseEnter('hoverLegs')} style= {this.state.Legs || this.state.hoverLegs ? {opacity:1} : {opacity:0}}>
                ...
                <div className="back-female-shoulder" onClick={this.handleShouldersClick} onMouseLeave={()=>this.handleMouseLeave('hoverShoulders')} onMouseEnter={()=>this.handleMouseEnter('hoverShoulders')} style= {this.state.Shoulders || this.state.hoverShoulders ? {opacity:1} : {opacity:0}}>
